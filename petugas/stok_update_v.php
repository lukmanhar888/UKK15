                   ...
                   <h2 class="text-white mb-4"></h2>
                            ...
                            <form class="custom-form volunteer-form mb-5 mb-lg-0" action="stok_update_m.php" method="post" role="form">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-12">    
                                        <input type="text" name="stok" value="<?= $barang['harga_barang'] ?>" class="form-control" placeholder="stok" required readonly>
                                    </div>

                                    <div class="">
                                        <input type="text" name="harga" value="<?= $barang['stok_barang'] ?>"  class="form-control" placeholder="Harga" >
                                    </div>
