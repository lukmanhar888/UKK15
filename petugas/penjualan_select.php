...
<div class="col-lg-10 col-12 text-center mx-auto">
    ...
    ?>
      <tr>
        ...
        <td><a href="penjualan_delete.php?id_pelanggan=<?= $pelanggan['id_pelanggan'] ?>"  onclick="return confirm('apakah anda yakin mau delete?');"  class=" custom-btn btn  text-bg-danger mt-2 ">Dalete</a></td>
        <td><a href="detail_penjualan_v.php?id_pelanggan=<?= $pelanggan['id_pelanggan'] ?>" class=" custom-btn btn text-bg-info mt-2 ">Transaksi</a></td>
      </tr>
    <?php } ?>
                        </tbody>
                    </table>
