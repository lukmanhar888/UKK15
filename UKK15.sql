...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 06, 2024 at 05:31 AM
...
--
CREATE DATABASE IF NOT EXISTS `db_kasir_15` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `db_kasir_15`;
...
(1, 'sarung', 1994, 17000.00),
(2, 'rinso', 2000, 18000.00);
...
(1, 'haris', 'haris', '123', 'Administrator'),
(3, 'adib', 'adib', '123', 'Petugas');
...
('root', '[{\"db\":\"db_kasir_15\",\"table\":\"tb_login\"},{\"db\":\"db_kasir_15\",\"table\":\"tb_detail_penjualan\"},{\"db\":\"db_kasir_15\",\"table\":\"tb_penjualan\"},{\"db\":\"db_kasir_15\",\"table\":\"tb_pelanggan\"},{\"db\":\"db_kasir_15\",\"table\":\"tb_barang\"}]');
...
('db_kasir_15', 'tb_barang', 1, 642, 79),
('db_kasir_15', 'tb_detail_penjualan', 1, 676, 217),
('db_kasir_15', 'tb_login', 1, 329, 204),
('db_kasir_15', 'tb_pelanggan', 1, 201, 188),
('db_kasir_15', 'tb_penjualan', 1, 191, 21);
...
('root', '2024-03-06 04:31:24', '{\"Console\\/Mode\":\"collapse\",\"NavigationWidth\":0}');
