                        ...
                        <div class="col-lg-6 col-12 mx-auto">
                            ...
                            <form class="custom-form volunteer-form mb-5 mb-lg-0" action="pendataan_update_m.php" method="post" role="form">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-12">    
                                        <input type="text" name="harga" value="<?= $barang['harga_barang'] ?>" class="form-control" placeholder="stok" required>
                                    </div>

                                    <div class="">
                                        <input type="text" name="stok" value="<?= $barang['stok_barang'] ?>"  class="form-control" placeholder="Harga" required>
                                    </div>
